...
public class ProjectInstanceId {
   ...
   */
  public ProjectInstanceId(UUID projectBlueprintUuid, UUID userUuid) {
    this.projectBlueprintUuid = projectBlueprintUuid;
    this.userUuid = userUuid;
  }

  public ProjectInstanceId projectBlueprintUuid(UUID projectBlueprintUuid) {
    this.projectBlueprintUuid = projectBlueprintUuid;
    return this;
  }
  ...
  public ProjectInstanceId userUuid(UUID userUuid) {
    this.userUuid = userUuid;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectInstanceId projectInstanceId = (ProjectInstanceId) o;
    return Objects.equals(this.projectBlueprintUuid, projectInstanceId.projectBlueprintUuid) &&
        Objects.equals(this.userUuid, projectInstanceId.userUuid);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectInstanceId {\n");
